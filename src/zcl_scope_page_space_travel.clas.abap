CLASS zcl_scope_page_space_travel DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_scope_page_space_travel IMPLEMENTATION.
...
*
** Page template
*    ( object = if_aps_bc_scope_change_api=>gc_tadir_object-UIPG obj_name = 'ZMS80_TRAVEL_080' )
*    )
*
